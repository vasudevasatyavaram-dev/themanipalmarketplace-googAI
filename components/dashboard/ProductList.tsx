      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="border-t border-brand-dark/10 pt-3 mt-auto">
            <div className="flex justify-between items-center text-sm text-brand-dark/70 mb-3">
                <p>Stock: <span className="font-bold text-brand-dark">{product.quantity_left}</span></p>
                <p>Type: <span className="font-bold text-brand-dark capitalize">{product.type}</span></p>
            </div>
